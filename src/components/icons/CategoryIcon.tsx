const CategoryIcon = () => {
	return (
		<svg
			...
			<path
				d="M11.1501 3.40001L7.43012 9.48001C7.02012 10.14 7.50012 11 8.28012 11H15.7101C16.4901 11 16.9701 10.14 16.5601 9.48001L12.8501 3.40001C12.4601 2.76001 11.5401 2.76001 11.1501 3.40001Z"
				fill="currentColor"
			/>
			<path
